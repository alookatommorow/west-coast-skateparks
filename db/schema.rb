...
ActiveRecord::Schema.define(version: 2020_10_05_162232) do
  ...
  create_table "favorites", id: :serial, force: :cascade do |t|
    ...
    t.index ["user_id", "skatepark_id"], name: "index_favorites_on_user_id_and_skatepark_id", unique: true
  ...
  create_table "ratings", id: :serial, force: :cascade do |t|
    ...
    t.index ["user_id", "skatepark_id"], name: "index_ratings_on_user_id_and_skatepark_id"
  ...
  create_table "reviews", id: :serial, force: :cascade do |t|
    ...
    t.index ["user_id", "skatepark_id"], name: "index_reviews_on_user_id_and_skatepark_id", unique: true
  ...
  create_table "visits", id: :serial, force: :cascade do |t|
    ...
    t.index ["user_id", "skatepark_id"], name: "index_visits_on_user_id_and_skatepark_id", unique: true
