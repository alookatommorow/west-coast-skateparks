...
class PlacesAutocomplete extends React.Component {
  ...
  stateFilter = option => {
    ...
    return description.indexOf('CA, USA') > -1 || description.indexOf('OR, USA') > -1 || description.indexOf('WA, USA') > -1;
  }
  ...
  autocompleteCallback = (predictions, status) => {
    ...
    this.setState({
      suggestions: predictions.filter(this.stateFilter).map((p, idx) => ({
        id: p.id,
