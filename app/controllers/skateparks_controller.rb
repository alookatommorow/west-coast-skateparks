class SkateparksController < ApplicationController
  ...
  def search
    ...
    if params[:search]
      @skateparks = Skatepark.where("name LIKE ? OR city LIKE ? OR state LIKE ?", "%" +params[:search].capitalize + "%", "%" +params[:search].capitalize + "%", "%" +params[:search].capitalize + "%").order("state ASC").order("city ASC").order("name ASC")
