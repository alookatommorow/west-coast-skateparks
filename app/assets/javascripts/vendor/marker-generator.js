function MarkerGenerator(map, skateparks) {
  ...
  function generateContentString(skatepark) {
    ...
    return "<div id='content' style='height:50%'><div class='center-text two-bottom'><img style='height:50px' src='"+skatepark.firstPicture+ "' ></div><strong><a href='/skateparks/"+skatepark.id+"'>"+titleize(skatepark.name)+"</a></strong></div>";
  }
